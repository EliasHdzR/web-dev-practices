...
<div class="row">
    <div class="leftcolumn">
        <div class="card">
            <h3>Archivos de <?= $usuario["nombre"] . " " . $usuario["apellidos"] ?></h3>
            ...
            <input type="hidden" id="propietario-id" value="<?= $propietarioID ?>">
...
<script src="<?= APP_ROOT ?>js/ver_archivos.js"></script>
</body>
</html>
